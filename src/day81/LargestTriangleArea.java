...
public class LargestTriangleArea {
    ...
    public static void main(String[] args) {
        int[][] trianglePoints = {{0, 0}, {1, 0}, {0, 1}};

        LargestTriangleArea largestTriangleAreaCalculator = new LargestTriangleArea();

        double result = largestTriangleAreaCalculator.largestTriangleArea(trianglePoints);
